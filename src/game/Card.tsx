...
class Card extends Phaser.GameObjects.Container {
  ...
  upgrades: Array<Phaser.GameObjects.Image>;
  cardsUnderneath: Array<Phaser.GameObjects.Image>;
  ...
  render() {
    ...
    tokens.forEach((type, i) => {
      ...
      if (tokenData[type] > 0) {
        ...
        if (type !== 'stun') {
          // @ts-ignore // TODO
          const text = new Phaser.GameObjects.Text(this.scene, position[0], position[1], tokenData[type], { color: '#fff', stroke: '#000', strokeThickness: 4, fontSize: '22px' });
          text.setOrigin(0.5);
          this.add(text);
        }
      }
